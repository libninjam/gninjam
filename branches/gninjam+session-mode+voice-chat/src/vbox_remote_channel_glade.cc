// generated 2008/2/14 2:20:41 CET by tobias@THINKPAD-T43.(none)
...
{  
   ...
   checkbutton_remote_receive = Gtk::manage(new class Gtk::CheckButton(_("R")));
   entry_remote_sessionstate = Gtk::manage(new class Gtk::Entry());
   combobox_remote_output = Gtk::manage(new class Gtk::ComboBox());
   checkbutton_remote_stereo = Gtk::manage(new class Gtk::CheckButton(_("St")));
   checkbutton_remote_mute = Gtk::manage(new class Gtk::CheckButton(_("M")));
   checkbutton_remote_solo = Gtk::manage(new class Gtk::CheckButton(_("S")));
   ...
   _tooltips.set_tip(*checkbutton_remote_receive, _("Receive"), "");
   checkbutton_remote_receive->set_relief(Gtk::RELIEF_NORMAL);
   checkbutton_remote_receive->set_mode(false);
   checkbutton_remote_receive->set_active(false);
   entry_remote_sessionstate->set_name("entry_remote_sessionstate");
   entry_remote_sessionstate->set_flags(Gtk::CAN_FOCUS);
   entry_remote_sessionstate->set_visibility(true);
   entry_remote_sessionstate->set_editable(false);
   entry_remote_sessionstate->set_max_length(0);
   entry_remote_sessionstate->set_text("");
   entry_remote_sessionstate->set_has_frame(true);
   entry_remote_sessionstate->set_activates_default(false);
   ...
   _tooltips.set_tip(*checkbutton_remote_stereo, _("Stereo"), "");
   checkbutton_remote_stereo->set_relief(Gtk::RELIEF_NORMAL);
   checkbutton_remote_stereo->set_mode(false);
   ...
   _tooltips.set_tip(*checkbutton_remote_mute, _("Mute"), "");
   checkbutton_remote_mute->set_relief(Gtk::RELIEF_NORMAL);
   checkbutton_remote_mute->set_mode(false);
   ...
   _tooltips.set_tip(*checkbutton_remote_solo, _("Solo"), "");
   checkbutton_remote_solo->set_relief(Gtk::RELIEF_NORMAL);
   checkbutton_remote_solo->set_mode(false);
   ...
   hbox4->pack_start(*entry_remote_sessionstate);
   hbox4->pack_start(*combobox_remote_output, Gtk::PACK_SHRINK, 0);
   hbox4->pack_start(*checkbutton_remote_stereo, Gtk::PACK_SHRINK, 0);
   hbox4->pack_start(*checkbutton_remote_mute, Gtk::PACK_SHRINK, 0);
   hbox4->pack_start(*checkbutton_remote_solo, Gtk::PACK_SHRINK, 0);
   ...
   hbox5->pack_start(*progressbar_remote, Gtk::PACK_SHRINK, 0);
   ...
   entry_remote_sessionstate->show();
