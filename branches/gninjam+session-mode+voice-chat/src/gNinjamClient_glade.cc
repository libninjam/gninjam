...
{  
   ...
   checkbutton_master_mute = Gtk::manage(new class Gtk::CheckButton(_("M")));
   checkbutton_metronome_mute = Gtk::manage(new class Gtk::CheckButton(_("M")));
   ...
   checkbutton_metronome_stereo = Gtk::manage(new class Gtk::CheckButton(_("St")));
   progressbar_master = Gtk::manage(new class Gtk::ProgressBar());
   checkbutton_sessionmode = Gtk::manage(new class Gtk::CheckButton(_("Session Mode")));
   ...
   _tooltips.set_tip(*checkbutton_master_mute, _("Mute"), "");
   checkbutton_master_mute->set_relief(Gtk::RELIEF_NORMAL);
   checkbutton_master_mute->set_mode(false);
   ...
   _tooltips.set_tip(*checkbutton_metronome_mute, _("Mute"), "");
   checkbutton_metronome_mute->set_relief(Gtk::RELIEF_NORMAL);
   checkbutton_metronome_mute->set_mode(false);
   ...
   _tooltips.set_tip(*checkbutton_metronome_stereo, _("Stereo"), "");
   checkbutton_metronome_stereo->set_relief(Gtk::RELIEF_NORMAL);
   checkbutton_metronome_stereo->set_mode(false);
   checkbutton_metronome_stereo->set_active(false);
   progressbar_master->set_name("progressbar_master");
   checkbutton_sessionmode->set_name("checkbutton_sessionmode");
   checkbutton_sessionmode->set_flags(Gtk::CAN_FOCUS);
   _tooltips.set_tip(*checkbutton_sessionmode, _("Session Mode"), "");
   checkbutton_sessionmode->set_relief(Gtk::RELIEF_NORMAL);
   checkbutton_sessionmode->set_mode(false);
   checkbutton_sessionmode->set_active(false);
   ...
   table2->attach(*progressbar_master, 4, 7, 0, 1, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table2->attach(*checkbutton_sessionmode, 6, 7, 1, 2, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table2->attach(*combobox_metronome_output, 5, 6, 1, 2, Gtk::FILL, Gtk::FILL, 0, 0);
   ...
   vpaned2->pack1(*frame_local, Gtk::EXPAND|Gtk::SHRINK);
   ...
   hpaned1->pack1(*vpaned2, Gtk::EXPAND|Gtk::SHRINK);
   ...
   checkbutton_sessionmode->signal_toggled().connect(SigC::slot(*this, &gNinjamClient_glade::on_checkbutton_sessionmode_toggled), false);
