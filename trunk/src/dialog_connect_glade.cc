// generated 2006/11/18 13:40:20 CET by tobias@THINKPAD-T43.(none)
...
{  dialog_connect = this;
   ...
   Gtk::Label *label4 = Gtk::manage(new class Gtk::Label("Hostname"));
   Gtk::Label *label5 = Gtk::manage(new class Gtk::Label("Username"));
   Gtk::Label *label6 = Gtk::manage(new class Gtk::Label("Password"));
   ...
   dialog_connect->set_title("Connect");
