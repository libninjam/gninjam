...
{  
   ...
   checkbutton_metronome_stereo = Gtk::manage(new class Gtk::CheckButton("Stereo"));
   ...
   menuitem3_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("_Local channels"));
   local_channels1 = (Gtk::CheckMenuItem *)&menuitem3_menu->items().back();
   
   menuitem3_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("_Remote channels"));
   remote_channels1 = (Gtk::CheckMenuItem *)&menuitem3_menu->items().back();
   
   menuitem3_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("_Chat"));
   ...
   menubar1->items().push_back(Gtk::Menu_Helpers::MenuElem("_Ansicht", *menuitem3_menu));
